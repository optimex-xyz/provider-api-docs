...
| Field    | Type     | Description                                                   |
| -------- | -------- | ------------------------------------------------------------- |
| `trades` | `array`  | Array of trade objects (same structure as Get Trade Details)  |
...
Each trade object contains the same fields as the [Get Trade Details](#3-get-trade-details) response, including:
