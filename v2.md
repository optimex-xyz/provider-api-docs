...
Retrieves a paginated list of trades with optional filtering. Each trade in the list contains the same detailed information as the Get Trade Details endpoint.
...
| `state`             | `string`   | No       | Filter trades by state                                   |
| `deposit_tx_id`     | `string`   | No       | Filter by deposit transaction hash                       |
| `from_user_address` | `string[]` | No       | Filter by source addresses (array of addresses)          |
| `to_user_address`   | `string[]` | No       | Filter by destination addresses (array of addresses)     |
...
| Field     | Type     | Description                                                              |
| --------- | -------- | ------------------------------------------------------------------------ |
| `data`    | `array`  | Array of trade objects (same structure as Get Trade Details)             |
| `paging`  | `object` | Pagination information (see Paging Object)                               |
...
Each trade object in the `data` array contains the same fields as the [Get Trade Details](#3-get-trade-details) response, including:
...
> **Note:** Refer to [Get Trade Details](#3-get-trade-details) for complete documentation of Token Object, Event Object, and Event Actions.
...
```json
{
  "data": [
    {
      "trade_id": "0x933f6ffc2aa3aac0cb6057d1c32872f3725e7f42b0607a06966c07746b32dfc2",
      "state": "success",
      "trade_timeout": 1765533005,
      "script_timeout": 1765605005,
      "from_user_address": "tb1p0k7s75ddzr8wrst9raalymqkrzpz6ppcwtph0mqwx0j7kmg39sjq5553aj",
      "to_user_address": "0x19ce4de99ce88bc4a759e8dbdec42724eecb666f",
      "deposit_tx": "f5852722ece198f5b857415b2b730b4827ed08e0741d17e8e6fc219817caf25d",
      "settlement_tx": "0x328e3a4a4e86db6d7b2acc3253f5d64d5a20c04d316fe0d3405cc17ac290a2c6",
      "swap_type": "direct",
      "amount_in": "15000",
      "min_amount_out": "4108960871745926",
      "from_token": {
        "id": 2,
        "chain_id": "",
        "token_id": "tBTC",
      ...
      "to_token": {
        ...
        "token_symbol": "ETH",
        "token_address": "native",
        "token_logo_uri": "https://static.optimex.xyz/crypto_svg_logos/eth.svg",
        "network_symbol": "ETH",
        "token_decimals": 18,
        "network_logo_uri": "https://static.optimex.xyz/crypto_svg_logos/eth_network.svg",
        "canonical_token_id": "",
        "across_token_address": "0xfFf9976782d46CC05630D1f6eBAb18b2324d6B14"
      },
      "events": [
        {
          "action": "ConfirmSettlement",
          "tx_id": "0xa679e6240cb43056ce23b6c9db97c49462521d64055df6b36742ec084865d2ac",
          "block_number": 14167135,
          "timestamp": 1765518806,
          "input_data": {
            "trade_id": "0x933f6ffc2aa3aac0cb6057d1c32872f3725e7f42b0607a06966c07746b32dfc2",
            "release_tx_id": "7a31ab73a05adf191131bc2684ff3db1ce2429f435536b09ce47ce9ad2900dde"
          }
        },
        {
          "action": "INIT",
  ...
  "traceId": "req-019b111f-7f93-7328-a56c-7e267a03a2d1"
}
```
